...
if (isset($_POST["submit"])) {
    ...
    $unread = $unread + 1;
//Check empty fields
    if ($_POST['to_user'] == '') {$usrerror = "<label class=\"text-danger\">\"To user\" cannot be empty</label>";
        $error = "<label class=\"text-danger\">An error occured, please check input.</label>";}
    if ($_POST['message'] == '') {$msgerror = "<label class=\"text-danger\">\"Message\" cannot be empty</label>";
        $error = "<label class=\"text-danger\">An error occured, please check input.</label>";}
    if ($_POST['subject'] == '') {$suberror = "<label class=\"text-danger\">\"Subject\" cannot be empty</label>";
        $error = "<label class=\"text-danger\">An error occured, please check input.</label>";}
    if (!$error) {
            ...
            <table class="table table-bordered" style="background-color: rgba(255, 255, 255, 0.4);">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="to_user" maxlength="32" value="<?php echo $_GET['user']; ?>" style="width:100%;"
                            disabled>
                        <?php }?>
                        <?php if (!isset($_GET['user'])) {?>
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <input type="text" name="subject" maxlength="255" value="<?php echo $_GET['subject']; ?>" style="width:100%;"
                            disabled>
                        <?php }?>
                        <?php if (!isset($_GET['subject'])) {?>
