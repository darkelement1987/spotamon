            ...
            <div class="modal-content" id="auth-modal-content">
                <div class="modal-body p-0">
                    <div class="login-row row login-modal">
                        <div class="col-md-5 justify-content-center discord-modal" id="discordloginbody">
                            <a href="<?=W_FUNCTIONS?>auth.php?form=discordlogin" class="d-flex justify-content-center">
                                <img src="<?=W_ASSETS?>img/Discord_Logo.png" width="150px" alt="Discord" id="discord-logo-login" class="d-flex" />
                            </a>
                        ...
                        <div class="col-md-7 email-modal" id="emailmodalbody">
                            ...
                            <form class="login-form" id="loginform" action="<?=W_FUNCTIONS?>auth.php" method="post">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control login-fields" name="username" placeholder="Username/Email" required minlength="8"
                                            oninvalid="this.setCustomValidity('This does not seem to be a valid username, sorry')"
                                            maxlength="20" pattern='^[a-zA-Z0-9#_-]{8,20}$' />
                                    </div>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text login-fields">
                                        ...
                                        <input type="password" name="password" pattern="^(?=.*[A-Z])(?=.*[a-z])(?=.*[0-9])([^\s]).{8,20}$" maxlength="18" oninvalid="this.setCustomValidity('Password must contain: \n1 Capital, 1 Lowercase\n1 Number, and be 8-20 characters long.')"
                                            minlength="8" placeholder="Password" class="form-control login-fields" required
                                        />
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    <p>
                                        <strong class="login-fields" style="  font-size:14px; margin-top:7px;">Not a Member
                                            Yet??
                                        </strong>
                                    </p>
                                </div>
                ...
                <div class="register-row row login-modal">
                    <div class="col-md-5 justify-content-center discord-modal">
                        <a href="<?=W_FUNCTIONS?>auth.php?form=discordregister" class="d-flex justify-content-center">
                        ...
                        <form class="register-form" method="post" action="<?=W_FUNCTIONS?>auth.php">
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control login-fields" name="username" placeholder="Username" minlength="8" max-length="20"
                                        pattern='^[a-zA-Z0-9#]([._](?![._])|[a-zA-Z0-9#]){8,20}[a-zA-Z0-9]$' required />
                                </div>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text login-fields">
                                    ...
                                    <input type="password" name="password" placeholder="Password" class="form-control login-fields" pattern="^\S*(?=\S{8,})(?=\S*[a-z])(?=[\S\W]*)(?=\S*[A-Z])(?=\S*[\d])\S*$"
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="password" name="confirmpassword" placeholder="Confirm Password" class="form-control login-fields" pattern='^\S*(?=\S{8,})(?=\S*[a-z])(?=[\S\W]*)(?=\S*[A-Z])(?=\S*[\d])\S*$'
                                        oninvalid="this.setCustomValidity('Password must contain: \n1 Capital, 1 Lowercase\n1 Number, and be 8-20 characters long.')"
