  ...
  var infoWindow = new google.maps.InfoWindow;
    ...
    downloadUrl('./frontend/xml.php', function(data) {
      ...
      Array.prototype.forEach.call(markers, function(markerElem) {
		...
		var spotterpic = markerElem.getAttribute('spotterpic');
		...
		markerElem.getAttribute('latitude') + ',' + markerElem.getAttribute('longitude') + '\">Google Maps</a><?php if(isset($_SESSION["uname"])){?><br><hr>Spotted by: <img src=\"<?php echo $viewurl;?>/userpics/' + spotterpic + '\" height=\"25\" width=\"25\" style=\"border:1px solid black\"> <b>' + spotter + '</b><?php }?></center></div>';
	...
	downloadUrl('./frontend/gxml.php', function(data) {
      ...
      Array.prototype.forEach.call(markers, function(markerElem) {
		...
		var teamby = markerElem.getAttribute('teamby');
		var teambypic = markerElem.getAttribute('teambypic');
		var raidbypic = markerElem.getAttribute('raidbypic');
		var eggbypic = markerElem.getAttribute('eggbypic');
		...
		var exraidby = markerElem.getAttribute('exraidby');
		var exraidbypic = markerElem.getAttribute('exraidbypic');		
		var point = new google.maps.LatLng(
		...
		if (actraid === "0" && egg === "0"){
			...
			var html = '<div class=\"maplabel\"><center><img src=\"./static/gyms/' + gteam + '.png\" height=\"45px\" width=\"45px\"></img><p><b>' + gname + '</b><br>Team: ' + tid + '<br><br><b>Spotted by:</b><br><img src=\"<?php echo $viewurl;?>/userpics/' + teambypic + '\" height=\"25\" width=\"25\" style=\"border:1px solid black\"> ' + teamby + '<?php if(!isset($_SESSION["uname"])){?><hr><b><span class="text-danger">Login to change/add teams or raids.</span></b><?php }?><?php if(isset($_SESSION["uname"])){?><br><hr><b>Choose team:</b><br><form action=\"./gymteam.php\" name=\"postInstinct\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"2\"></form><form action=\"./gymteam.php\" name=\"postValor\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"3\"></form><form action=\"./gymteam.php\" name=\"postMystic\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"4\"></form><a href=\"javascript:submitInstinct();\"><img border="0" alt="W3Schools" src="./static/teams/2.png" width="25" height="25"></a> / <a href="javascript:submitValor();\"><img border="0" alt="W3Schools" src="./static/teams/3.png" width="25" height="25"></a> / <a href="javascript:submitMystic();\"><img border="0" alt="W3Schools" src="./static/teams/4.png" width="25" height="25"></a><?php };?><br><hr><a href=\"http://maps.google.com/maps?q=' + markerElem.getAttribute('glatitude') + ',' + markerElem.getAttribute('glongitude') + '\">Google Maps</a></center></div>';
			var icon = customLabel[type] || {};
			var image = {
			...
			if (exraid === "0"){
			var html = '<div class=\"maplabel\"><center><img src=\"./static/icons/' + actboss + '.png\" height=\"45px\" width=\"45px\"></img><p><b>' + gname + '</b><br>Boss: ' + bossname + '<br>CP: ' + bosscp + '<br>Team: ' + tid + '<br><br><b>Spotted by:</b><br><img src=\"<?php echo $viewurl;?>/userpics/' + teambypic + '\" height=\"25\" width=\"25\" style=\"border:1px solid black\"> ' + teamby + '<br>Expires: ' + hour + ':' + min + ' ' + ampm + '<?php if(!isset($_SESSION["uname"])){?><hr><b><span class="text-danger">Login to change/add teams or raids.</span></b><?php }?><?php if(isset($_SESSION["uname"])){?><br><hr><b>Choose team:</b><br><form action=\"./gymteam.php\" name=\"postInstinct\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"2\"></form><form action=\"./gymteam.php\" name=\"postValor\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"3\"></form><form action=\"./gymteam.php\" name=\"postMystic\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"4\"></form><a href=\"javascript:submitInstinct();\"><img border="0" alt="W3Schools" src="./static/teams/2.png" width="25" height="25"></a> / <a href="javascript:submitValor();\"><img border="0" alt="W3Schools" src="./static/teams/3.png" width="25" height="25"></a> / <a href="javascript:submitMystic();\"><img border="0" alt="W3Schools" src="./static/teams/4.png" width="25" height="25"></a><?php };?><br><hr><a href=\"http://maps.google.com/maps?q=' + markerElem.getAttribute('glatitude') + ',' + markerElem.getAttribute('glongitude') + '\">Google Maps</a><?php if(isset($_SESSION["uname"])){?><br><hr><b>Spotted by: <img src=\"<?php echo $viewurl;?>/userpics/' + raidbypic + '\" height=\"25\" width=\"25\" style=\"border:1px solid black\"> </b>' + raidby + '<?php }?></center></div>';
			var icon = customLabel[type] || {};
			var image = {
			...
			var html = '<div class=\"maplabel\"><center><img src=\"./static/icons/' + actboss + '.png\" height=\"45px\" width=\"45px\"></img><p><b>' + gname + '</b><br>Boss: ' + bossname + '<br>CP: ' + bosscp + '<br>Team: ' + tid + '<br><br><b>Spotted by:</b><br><img src=\"<?php echo $viewurl;?>/userpics/' + teambypic + '\" height=\"25\" width=\"25\" style=\"border:1px solid black\"> ' + teamby + '<br>Expires: ' + hour + ':' + min + ' ' + ampm + '<?php if(!isset($_SESSION["uname"])){?><hr><b><span class="text-danger">Login to change/add teams or raids.</span></b><?php }?><?php if(isset($_SESSION["uname"])){?><br><hr><strong>EX Raid On:</strong><br> ' + exraiddate + '<br><br><b>Spotted by:</b><br><img src=\"<?php echo $viewurl;?>/userpics/' + raidbypic + '\" height=\"25\" width=\"25\" style=\"border:1px solid black\"> ' + exraidby + '<hr><b>Choose team:</b><br><form action=\"./gymteam.php\" name=\"postInstinct\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"2\"></form><form action=\"./gymteam.php\" name=\"postValor\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"3\"></form><form action=\"./gymteam.php\" name=\"postMystic\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"4\"></form><a href=\"javascript:submitInstinct();\"><img border="0" alt="W3Schools" src="./static/teams/2.png" width="25" height="25"></a> / <a href="javascript:submitValor();\"><img border="0" alt="W3Schools" src="./static/teams/3.png" width="25" height="25"></a> / <a href="javascript:submitMystic();\"><img border="0" alt="W3Schools" src="./static/teams/4.png" width="25" height="25"></a><?php };?><br><hr><a href=\"http://maps.google.com/maps?q=' + markerElem.getAttribute('glatitude') + ',' + markerElem.getAttribute('glongitude') + '\">Google Maps</a><?php if(isset($_SESSION["uname"])){?><br><hr><b>Spotted by: <img src=\"<?php echo $viewurl;?>/userpics/' + raidbypic + '\" height=\"25\" width=\"25\" style=\"border:1px solid black\"> </b>' + raidby + '<?php }?></center></div>';
			var icon = customLabel[type] || {};
			var image = {
            url: './static/raids/' + actboss + '.png',
            scaledSize: new google.maps.Size(75, 75)
			...
			if (exraid === "0"){
			var html = '<div class=\"maplabel\"><center><img src=\"./static/eggs/' + egg + '.png\" height=\"45px\" width=\"45px\"></img><p><b>' + gname + '</b><br>Egg level: ' + egg + '<br>Team: ' + tid + '<br><br><b>Spotted by:</b><br><img src=\"<?php echo $viewurl;?>/userpics/' + teambypic + '\" height=\"25\" width=\"25\" style=\"border:1px solid black\"> ' + teamby + '<br>Hatches at: ' + hour + ':' + min + ' ' + ampm + '<?php if(!isset($_SESSION["uname"])){?><hr><b><span class="text-danger">Login to change/add teams or raids.</span></b><?php }?><?php if(isset($_SESSION["uname"])){?><br><hr><b>Choose team:</b><br><form action=\"./gymteam.php\" name=\"postInstinct\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"2\"></form><form action=\"./gymteam.php\" name=\"postValor\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"3\"></form><form action=\"./gymteam.php\" name=\"postMystic\" method=\"post\"\"><input type=\"hidden\" name=\"gname\" value=\"' + gid + '\"><input type=\"hidden\" name=\"tname\" value=\"4\"></form><a href=\"javascript:submitInstinct();\"><img border="0" alt="W3Schools" src="./static/teams/2.png" width="25" height="25"></a> / <a href="javascript:submitValor();\"><img border="0" alt="W3Schools" src="./static/teams/3.png" width="25" height="25"></a> / <a href="javascript:submitMystic();\"><img border="0" alt="W3Schools" src="./static/teams/4.png" width="25" height="25"></a><?php };?><br><hr><a href=\"http://maps.google.com/maps?q=' + markerElem.getAttribute('glatitude') + ',' + markerElem.getAttribute('glongitude') + '\">Google Maps</a><?php if(isset($_SESSION["uname"])){?><br><hr><b>Spotted by: <img src=\"<?php echo $viewurl;?>/userpics/' + eggbypic + '\" height=\"25\" width=\"25\" style=\"border:1px solid black\"> </b>' + eggby + '<?php }?></center></div>';		
			var icon = customLabel[type] || {};
			var image = {
	...
	downloadUrl('./frontend/sxml.php', function(data) {
      ...
      Array.prototype.forEach.call(markers, function(markerElem) {
        ...
        var questbypic = markerElem.getAttribute('questbypic');
		var point = new google.maps.LatLng(
