...
<form id="usersubmit" method="post" action="frontend/spot.php">
    ...
    while ($row = $result->fetch_assoc()) {
        unset($id, $pokemon);
            $dexentry = $row['dexentry'];
                $monster= $row['monster']; 
					echo '<option value="#'.$dexentry.' - '.$monster.'"><img src="../icons/'.monid.'" alt="'.$pokemon.'" height="80" width="80"> '.$dexentry.' - '.$monster.'</option>';
